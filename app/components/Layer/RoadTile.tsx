...
export default function RoadTile({
  ...
  const { isVisible, toggleVisibility, deleteRoad } = useJalanStore(
    (state) => ({
      isVisible: state.isJalanVisible,
      toggleVisibility: state.toggleJalanVisibility,
      deleteRoad: state.deleteRoad,
    })
  );
